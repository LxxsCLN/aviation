...
const NavBar = () => {
  ...
  useEffect(() => {
    ...
    const theme = localStorage.getItem("darkMode") ? true : false
    localStorage.setItem("darkMode", theme)
    document.querySelector("html").setAttribute("data-theme", theme ? "night" : "light")
    setTheme(theme)
  }, [])
  ...
  return (
    <div className="navbar bg-base-100">
      <div className="flex-1">
        <a className="text-xl btn btn-ghost">aviation</a>
      </div>
      <div className="flex-none gap-2">
        <ul className="px-1 menu menu-horizontal">
          <li><a>Link</a></li>
          <label className="swap swap-rotate">
            <input type="checkbox" onChange={handeChangeTheme} />
